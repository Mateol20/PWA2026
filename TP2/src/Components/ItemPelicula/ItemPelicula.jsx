...
export default function ItemPelicula({ item, index }) {
  const [imgSrc, setImgSrc] = useState(
    item.Poster !== "N/A" ? item.Poster : (item.Images?.[0] || "https://placehold.co/400x600?text=Poster+No+Disponible")
  );
  ...
  return (
    <article 
      className="w-80 h-[29rem] bg-[#1e293b] border border-slate-700/50 rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.4)] flex flex-col hover:scale-105 transition-all duration-300 hover:border-blue-500/50 group"
    >
